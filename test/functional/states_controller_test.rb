...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { fortype: @state.fortype, is_default: @state.is_default, name: @state.name, sort_order: @state.sort_order }
    end
  ...
  test "should update state" do
    put :update, id: @state, state: { fortype: @state.fortype, is_default: @state.is_default, name: @state.name, sort_order: @state.sort_order }
    assert_redirected_to state_path(assigns(:state))
  end
